...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M9.425 10.254a.75.75 0 0 1 .821.671l.5 5a.75.75 0 0 1-1.492.15l-.5-5a.75.75 0 0 1 .671-.821ZM15.246 11.075a.75.75 0 0 0-1.492-.15l-.5 5a.75.75 0 0 0 1.492.15l.5-5Z"
    />
  </svg>
);
const IcTrash = memo(SvgComponent);
